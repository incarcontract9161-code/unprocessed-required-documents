...
# ==========================================
# GitHub에 업로드할 엑셀 파일명
EXCEL_FILE = "insurance_data.xlsb"  # ✅ 수정: .xlsx → .xlsb 변경
...
def ledger_pdf(families_by_dept, period_text, df_src):
    ...
    # ✅ 수정: SyntaxError 해결 (12mm → 12*mm, 15mm → 15*mm)
