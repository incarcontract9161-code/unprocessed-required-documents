...
# ==========================================
# 3. 집계 헬퍼 [수정: 대상건/스캔대상건/스캔율 분리 및 양식별 집계 포함]
# ==========================================
...
def dashboard_page():
    ...
    with tab_dash:
        ...
        # [수정] build_group_scan_stats 사용으로 양식별 집계 (FA_miss 등) 정확히 반영
        ...
        if agg.empty: st.info("조건에 맞는 데이터가 없습니다.")
            ...
            # [수정] 대상건, 대상스캔건, 스캔율, 미처리율 및 양식별 컬럼 반영
