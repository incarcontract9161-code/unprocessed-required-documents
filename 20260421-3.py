...
def report_excel(df, months):
    ...
    for _, row in report.iterrows():
        ...
        for ci,v in enumerate(vals,1):
            ...
            if isinstance(v,(int,float)): c.number_format = "#,##0" if ci < 6 else "0.0"
            if fill: c.fill=fill
        ri += 1
...
# ==========================================
# 9. 전체 페이지 PDF [수정: KeyError 방지 및 형식 변경]
# ==========================================
