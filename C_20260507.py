...
# ==========================================
# GitHub에 업로드할 엑셀 파일명
EXCEL_FILE = "insurance_data.xlsb"  # ✅ 수정: .xlsb 지원
...
def load_data():
    ...
    try:
        ...
        # ✅ 수정: converters={7: str} → H열(보험시작일, 0-based index 7)을 문자열로 강제 읽기
        #         pyxlsb 엔진이 날짜 셀을 엑셀 시리얼 번호로 변환하는 문제 방지
        #         예: 20260101 → "20260101" 형태의 문자열로 유지
        ...
        # ✅ 혼합 날짜 형식 파싱 (텍스트 + 엑셀 시리얼 넘버 동시 지원)
        raw_date = df["보험시작일 "]
        # 1차: 일반 문자열/날짜 파싱
